...
<p align="center">
<img src="./samples/pipeline.png" alt="image" width="400" height="auto">
</p>
...
### Results
Main comparison of End2end-Decompile approaches for re-executability rates on evaluation benchmarks:
<p align="center">
<img src="./samples/results.png" alt="results" width="800" height="auto">
</p>
...
*   ``input_asm_prompt``: assembly instructions with prompts, can be derived as in our [preprocessing example](https://github.com/anonepo/LLM4Decompile/blob/main/README.md#3-how-to-use-the-model).
...
```bash
git clone https://github.com/anonepo/LLM4Decompile.git
cd LLM4Decompile
